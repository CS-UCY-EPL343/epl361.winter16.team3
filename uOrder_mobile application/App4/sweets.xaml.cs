...
namespace App4
{
    ...
    public sealed partial class hotDrinks : Page
    {
        public hotDrinks()
        {
        ...
        /*
            Functions that add a specific product to the order list.  
        */
        private void add1_Click(object sender, RoutedEventArgs e)
        {
            viewOrder.myorder.Add(product1.Text + "\t\t" + price1.Text);
            viewOrder.prices.Add(2);
            add1.Content = "ADDED";
        ...
        /*
            Functions that increase the like counter of each product. 
        */
